...
- `remove.vars` (boolean, i.e., `true`, `false`): If `yes`, variables in the data that are missing from the metadata are removed from the data.
...
- `touch.na` (boolean, i.e., `true`, `false`):
