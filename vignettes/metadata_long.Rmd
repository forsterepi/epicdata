...
-   `options`: A list of options specifying study information, e.g. `study.name`, selection of workflow modules, e.g. `double.entry`, and defining global variable defaults, e.g. `date.format`.
...
-   `factor.id` or `id.factor` (): If `to.factor` is `yes` or not specified, a new variable is created and turned to factor while this variable stays integer. Provide to name of the new factor variable.
