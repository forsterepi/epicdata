...
| `to` |  | 1 | `to.exclude` |  |
| `to.exclude` |  | 1 | `to` |  |
| `date.format` | `format.date`, `format` (if `type` is `date`) | 1 |  |  |
| `time.format` | `format.time`, `format` (if `type` is `time`) | 1 |  |  |
| `datetime.format` | `format.datetime`, `format` (if `type` is `datetime`) | 1 |  |  |
...
+------------------------------------------------------------------------+-------------------+-------------------+-------------------------------------------------------------------------------------------------+
| `from`                                                                 | `from`            | `NULL`            | $-\infty$ (number, date, time, or datetime)                                                     |
+------------------------------------------------------------------------+-------------------+-------------------+-------------------------------------------------------------------------------------------------+
| `from.exclude`                                                         | `from.exclude`    | `NULL`            | $-\infty$ (number, date, time, or datetime)                                                     |
+------------------------------------------------------------------------+-------------------+-------------------+-------------------------------------------------------------------------------------------------+
| `to`                                                                   | `to`              | `NULL`            | $\infty$ (number, date, time, or datetime)                                                      |
+------------------------------------------------------------------------+-------------------+-------------------+-------------------------------------------------------------------------------------------------+
| `to.exclude`                                                           | `to.exclude`      | `NULL`            | $\infty$ (number, date, time, or datetime)                                                      |
+------------------------------------------------------------------------+-------------------+-------------------+-------------------------------------------------------------------------------------------------+
